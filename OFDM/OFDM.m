...
Pres = c^2*Ptrans*G*Gt/(4*pi*Fmain*D)^2;
Pnoize = k*T*DeltaFmain;%полосовой шум системы

w = -30.1;%сдвг по частоте между приемником и передатчиком в долях dF - разнос между несущими частотами
...
LevelOfIncreasing = 3;
NumbOfSymbol = 300; % количество OFDM символов.
